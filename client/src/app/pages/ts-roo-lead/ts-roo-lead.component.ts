...
@Component({
  selector: 'ngx-ts-roo-lead',
  templateUrl: './ts-roo-lead.component.html',
  styleUrls: ['./ts-roo-lead.component.scss']
})
export class TsRooLeadComponent implements OnInit {
  ...
  _calOff: string;
  _tsPrj: string;
  _rolCode: string = this.srGlbVar.rolGCDisLD;
  ...
  constructor(
    ...
    const obj = this.srSPXLst.getMRolIDByRoleName(this.srGlbVar.rolGCDisLD);
    obj.then((rs) => {
      this._pgRolID = rs;
    });
